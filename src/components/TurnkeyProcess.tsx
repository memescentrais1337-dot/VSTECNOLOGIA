  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Steps Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-6 border-t border-stone-200 pt-8">
        ...
        <div className="mt-16 p-6 sm:p-8 rounded-md bg-stone-900 text-white flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          <div>
          ...
          <button
            ...
            className="flex-shrink-0 inline-flex items-center gap-2 px-4 py-2.5 rounded-md bg-emerald-700 hover:bg-emerald-800 text-white text-xs sm:text-sm font-medium transition-colors"
          >
