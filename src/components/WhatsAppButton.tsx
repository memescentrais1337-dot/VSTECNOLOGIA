...
export const WhatsAppButton: React.FC = memo(() => {
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="w-12 h-12 sm:w-13 sm:h-13 bg-emerald-600 hover:bg-emerald-500 active:bg-emerald-700 text-white rounded-full flex items-center justify-center shadow-xl transition-transform duration-200 hover:scale-105 active:scale-95 focus:outline-none focus:ring-4 focus:ring-emerald-400/50"
        aria-label="Abrir conversa no WhatsApp com a VS Tecnologia"
      >
        <MessageCircle className="w-6 h-6 fill-white/20 stroke-white" />
      </a>
    </aside>
  );
});
