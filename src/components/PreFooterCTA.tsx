        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-8">
          ...
          <div className="flex-shrink-0">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-md bg-emerald-700 hover:bg-emerald-800 active:bg-emerald-900 text-white text-sm font-medium transition-colors"
            >
