  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-6 sm:mb-7 gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {projectsData.map((project) => (
            <div
              ...
              className="group cursor-pointer flex flex-col justify-between p-3 rounded-md border border-stone-200 hover:border-stone-400 bg-white shadow-2xs transition-all duration-200"
            >
              <div>
