...
export const solutionsLandingData: Record<string, SolutionLandingData> = {
  ...
  hanwha: {
    ...
    headline: 'Veja o que acontece.',
    headlineHighlight: 'Entenda antes que vire um problema.',
    subheadline:
      'Videomonitoramento inteligente para operações corporativas que precisam detectar, analisar e reagir a eventos em tempo real diretamente na borda.',
    heroBenefits: [
      ...
      'Escalabilidade modular e integração aberta com sistemas VMS',
    ],
  ...
  avigilon: {
    ...
    headline: 'Menos tempo procurando.',
    headlineHighlight: 'Mais tempo reagindo.',
    subheadline:
      'Tecnologia de vídeo analítico avançado e busca por aparência para operações corporativas que exigem localização imediata de alvos e gestão unificada de segurança.',
    heroBenefits: [
      'Busca Avançada por Aparência (Avigilon Appearance Search™)',
      'Detecção de Movimento Incomum e Anomalias de Comportamento (UMD)',
      'Câmeras Panorâmicas H6A e Multisensores de alta densidade de pixels',
  ...
  axis: {
    ...
    headline: 'Vídeo, áudio, acesso e analytics.',
    headlineHighlight: 'Uma operação conectada.',
    subheadline:
      'Ecossistema integrado de dispositivos inteligentes em rede para operações que buscam confiabilidade absoluta, padrões abertos e cibersegurança nativa.',
    heroBenefits: [
      'Ecossistema convergente: Vídeo IP, Áudio em Rede, Controle de Acesso e Sensores',
      'Processador ARTPEC-8 de última geração com unidade de Deep Learning (DLPU)',
      'Tecnologias líderes de imagem: Lightfinder 2.0 e Forensic WDR',
      'Plataforma aberta (VAPIX / ACAP) imune ao aprisionamento tecnológico (vendor lock-in)',
    ],
  ...
  pelco: {
    ...
    headlineHighlight: 'não é uma opção.',
    subheadline:
      'Plataformas robustas de videomonitoramento, câmeras de grau industrial e software VideoXpert para infraestruturas críticas com operação 24 horas por dia.',
    heroBenefits: [
      'Software VMS VideoXpert Enterprise com arquitetura tolerante a falhas',
      'Câmeras panorâmicas Sarix e linhas PTZ Spectra de altíssima durabilidade',
      'Cibersegurança sólida e conformidade rigorosa com normas de proteção',
      'Interoperabilidade garantida com dispositivos de terceiros via ONVIF',
    ],
  ...
  tyco: {
    ...
    headline: 'Um controlador preparado',
    headlineHighlight: 'para operações que não podem parar.',
    subheadline:
      'Controle de acesso de altíssima densidade, comunicação criptografada OSDP Secure e operação 100% autônoma offline para ambientes que demandam segurança física intransigente.',
    heroBenefits: [
      'Capacidade maciça para até 1.000.000 de usuários e 16 leitoras simultâneas (expansível até 32)',
