    ...
    <main className="pt-28 pb-16 bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <MotionReveal className="lg:col-span-6 space-y-5 text-sm sm:text-base text-stone-600 leading-relaxed">
          ...
          <MotionReveal className="lg:col-span-6" delay={0.12}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-stone-200">
        <MotionReveal className="max-w-3xl mb-10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 border-t border-stone-200">
        <MotionReveal className="max-w-2xl mb-8">
          <span className="text-xs font-semibold text-emerald-800 uppercase tracking-wider">
            Capacitação
          </span>
        ...
        <MotionStaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
          {certificationsData.map((c) => (
            <MotionStaggerItem key={c.id}>
              <div className="rounded-md bg-white border border-stone-200 overflow-hidden flex flex-col justify-between hover:border-stone-400 hover:shadow-xs transition-all h-full">
                <div>
